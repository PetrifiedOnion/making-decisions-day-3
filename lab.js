...
console.log ("Amy's age is greater then Brittani's age.")
}else if(amysAge === brittanisAge){
  console.log ("Amy and Brittani are the same age.")
}else{
  console.log ("Brittani's age is greater than Amy's age.")
}
...
console.log (`Amy and Brittani were born in the same year!`)
  ...
  console.log ('Brittani and Amy were born in different years. Lame.')
...
}else if(temperature <=32 && rain === true){
 console.log("Wear a snow coat.")
